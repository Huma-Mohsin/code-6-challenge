...
let invited_guest:string[]=["kate","Rainaha","Marie","Tom Cruise","salena"]
invited_guest.forEach(element => {
    console.log(`Dear ${element}, I just found a bigger dinner table, so now more space is available.`)
    console.log("\n")
});


let new_guests_tobe_invited:string[]=["Monica","Meldon","Alexa"]
